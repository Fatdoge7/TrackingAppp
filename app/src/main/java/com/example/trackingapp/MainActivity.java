...
public class MainActivity extends AppCompatActivity {
    ...
    private final String token = AppConstants.TOKEN;
    private final String bucket = AppConstants.BUCKET;
    private final String org = AppConstants.ORG;
    ...
    protected void onResume() {
        super.onResume();
        if (mapView != null) {
            mapView.onResume(); // Odśwież mapę po powrocie
        }
    }
    ...
    protected void onPause() {
        super.onPause();
        if (mapView != null) {
            mapView.onPause(); // Zatrzymaj mapę, gdy wychodzisz
        }
    }
